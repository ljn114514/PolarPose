...
class RandomHorizontalFlip(object):
    def __init__(self, flip_index, output_size, prob=0.5):
        ...
        #self.bbox_flip_index = [2, 1, 0, 3]
        self.bbox_flip_index = [1, 0, 3, 2]

    def __call__(self, image, mask, joints, area, bbox):

        #print('flip', self.output_size, self.prob, bbox.shape, joints.shape)
...
class RandomAffineTransform(object):
    ...
    def __call__(self, image, mask, joints, area, bbox):
        ...
        #print('center', center, self.scale_type, scale, aug_scale, aug_rot)
        ...
        if self.max_translate > 0:
            ...
            center[0] += dx
            center[1] += dy
            #print('translate', center, dx, dy, self.max_translate)
        ...
        #print('mat_output img', image.shape, mask.shape, joints.shape, bbox.shape)
